...
En näitä kaikkia ole ehtinyt laittaa tähän kokoelmaan, tässä ensimmäisiä maistiaiseksi. 
...
a ja d: Jos on leikatut poskiontelot, usein hoidon tärkein osa on mekaaninen tyhjennys, joka voidaan tehdä tylpällä lavaatiokärjellä keskikuorikon alta, jos potilaalle on tehty keskikäytävän antrostomia ja alakuorikon alta, jos on alakäytävässä aukko. Myös perinteinen punktio on vaihtoehtoisesti mahdollinen FESS-leikatulle. 
...
## 2-vuotias lapsi, jolla silmä on muurautunut umpeen. Lapsella on ollut kova nuha noin viikon ajan. Nyt lapsi kuumeilee ad 40o C. Lapsi on väsähtänyt ja kipeä.
...
b: Basalioomaepäilyn kanssa voi odottaa kyllä PAD-vastausta, ei ole niin kiirettä ESH-lähetteen kanssa. Monet basalioomat voi myös hoitaa itse PTH:ssa, kunhan vain varmistaa marginaalin toteutumisen. 
...
a: voi viitata ruokatorveen juuttuneeseen vierasesineeseen. Kilpiruston yläpuolella tuntuva pisto viittaa enemmänkin nielun tai kurkunpään vierasesineeseen. 
...
c: Väärin, siedätyshoidon toteutus ilma-allergeeneja vastaan kestää kolme vuotta. Siedätyshoito tehoaa noin 10 vuotta ja vähentää allergisen riniitin oireita sekä lääkehoidon tarvetta.
