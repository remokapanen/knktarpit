...
### Missä tilanteessa seuraavista ei tulisi epäillä äkillistä kartiolisäkkeen tulehdusta?

- a. Korvan takaa iho on punoittava ja aristava, korvalehti on hieman kääntynyt ulospäin ja tulehdusarvot ovat kohonneet
- b. Tärykalvo näyttää terveeltä, mutta korvakäytävässä, korvalehdessä ja korvan takana on turvotusta
- c. Potilaalla on korvatulehdus ja kaulan imusolmukkeet ovat sillä puolella kipeät ja suurentuneet
...
Mallivastauksissa on epäilty (ei siis varmuutta) oikeaksi vastaukseksi d, mutta b sinänsä sopii paremmin. Kartiolisäkkeen tulehdus eli mastoidiitti on tyypillisesti äkillisen välikorvatulehduksen suora komplikaatio ja tällöin tärykalvo ei näyttäisi terveeltä. Tilanne enemmänkin sopii otitis externaan ja korvalehden tulehdukseen. Korvan takainen turvotus kuitenkin sinänsä voisi aina herättää epäilyn mastoidiitista. 

d:n logiikka oikeana vastauksena voisi olla se, että kun tärykalvo puhkeaa, paine välikorvassa purkautuu, ja riski tulehduksen leviämiselle kartiolisäkkeeseen pienenee -> mastoidiitin hoitoon yleensä kuulukin laaja parasenteesi tai tympanostomia. Pelkkä märkävuoto ei viittaa mastoidiittiin, ellei siihen liity korvan takaista punoitusta, turvotusta, aristusta tai korvalehden työntymistä ulospäin. Kuitenkin mastoidiittipotilailla tärykalvo on usein suuren paineen vuoksi puhjennut spontaanisti (tai se on jouduttu puhkaisemaan), ja korvasta vuotaa jatkuvasti ja runsaasti märkää -> sopii sinänsä mastoiidin kuvaan ja kannattaisi epäillä mastoidiittia.

_Tämä kysymys on samanlaisena myös Turun vuoden 2026 blokin 4 tentissä, mutta siinä on poistettu b-vaihtoehto ja vaihdettu se selvemmin oikeaksi vaihtoehdoksi._
...
### Pullealla opettajalla uniapnea
...
- a. Lähetän potilaan suu- ja leukasairauksien yksikköön apneakiskon valmistamista varten
- b. Lähetän potilaan keuhkotaudeille CPAP-laitehoidon aloitusta varten
- c. Annan potilaalle ohjeet laihduttamisesta ja kehotan välttämään selkäasennossa nukkumista
- d. Lähetän potilaan korvaklinikalle arvioon nielurisaleikkausta ja suulakitoimenpidettä varten
...
Potilaalla on lievä (AHI <15) uniapnea, joka aiheuttaa merkittävää uneliaisuutta (ESS yli 9). Liikapainoisen uniapneapotilaan hoitoon kuuluvat aina painonhallinta ja elämäntapaohjaus. Lievässä uniapneassa laihdutus voi olla riittävä hoito. Jos potilas on vähäoireinen ja yöpolygrafiassa havaitaan lievä uniapnea tai osittainen unenaikainen ylähengitystieahtauma, perusterveydenhuollossa hänet ohjataan laihdutus- ja asentohoitoon.
...
d: Ei ole aiheellista lievässä oirekuvassa ainakaan ennen laihduttamisen kokeilemista.  
  </div>
</div>

### 6-vuotias lapsi. Äiti saattajana kertoo, että lapsella on ollut flunssamaisen nasaali puheääni hyvin pitkään, mahdollisesti siitä lähtien kun oppi puhumaan. Statuksessa rauhallinen nielu, tonsillat gr2, haarautunut uvula (uvula bifida) ja kovassa suulaessa palpoiden on pieni lovi limakalvon alla.

- a. Normaalilöydös, ei liity lapsen nasaalisuuteen
- b. Piilosuulakihalkio, selittää nasaalisuuden
- c. Tonsillahyperplasia aiheuttaa nasaalisuuden
- d. Huuli-suulakihalkio, ei liity nasaalisuuteen
...
Suulaki- ja huuli-suulakihalkiot ovat raskauden ensimmäisellä kolmanneksella syntyviä kehityshäiriöitä. Huuli-suulakihalkiot (cheilognathopalatoschisis) ja pelkät suulakihalkiot ovat kaksi erillistä kehityshäiriötä. Halkiot voivat olla tois- tai molemminpuolisia, osittaisia tai täydellisiä. 
...
d: Huuli-suulakihalkio olisi nähtävissä eikä piilossa; halkiot myös nimenomaan liittyvät nasaalisuuteen
  </div>
</div>

### Äänihuulen polyyppi

- a. esiintyy usein allergikolla
- b. paranee useimmiten ilman toimenpiteitä
- c. voi johtua äänihuulten traumasta
...
Toispuolisen äänihuulipolyypin taustalla lienee useimmiten äkillinen mekaaninen trauma, esimerkiksi yskän tai rykimisen tai erityisen voimakkaan äänenkäytön aiheuttama verenpurkauma. 
...
d: Isommat polyypit eivät oikein katoa itsestään -> poistetaan oireiden hoidoksi, ei dysplasian asteen arvioimiseksi

![](images/äänihuulipolyyppi.png)
  </div>
</div>

### 30-vuotias naisopettaja, harrastaa laulua. Kotona on kaksi lasta (9kk ja 3 v). Äänenkäheys alkoi syksyllä, kun hän palasi töihin äitiysloman jälkeen. Kurkunpää tutkittiin ja äänihuulissa todettiin symmetriset kyhmyt. Potilas kysyy hoitosuunnitelmasta.

- a. Annat antibioottikuurin ja pyydät kontrolliin kahden kk:n päästä
- b. Teet lähetteen foniatrian poliklinikkaan, mahdollisesti potilaalle järjestetään ääniterapia
- c. Laitat potilaalle PPI-lääkkeen kahdeksi kuukaudeksi
- d. Teet lähetteen korvaklinikkaan kyhmyjen poistoa varten
...
d: Jos ääniterapia ei auta, osa aikuisten äänihuulikyhmyistä hoidetaan harvoin kirurgisesti.  
  </div>
</div>

### Tytöllä flunssaa ja tympanometriatuloksia
...
- a. Oikealla on alipainetta. Arvioin, että oireet ovat aika lievät ja kehotan äitiä antamaan lapselle kipulääkettä sekä tulemaan uudelleen, jos oireet pahenevat tai eivät ala lievittyä parissa päivässä
- b. Koska lapsi on syönyt huonommin, epäilen streptokokin aiheuttamaa nielutulehdusta ja arvelen, että korvakipu heijastuu nielusta. Otan nieluviljelyn ja aloitan penisilliinikuurin.
- c. Aloitan antibiootin ja lähetän lapsen korvalääkärille tympanostomia-arvioon, koska nyt jo kolmas tulehdus
- d. Aloitan antibioottikuurin oikeanpuoleiseen korvatulehdukseen ja sovin kontrollin.
...
Korvien ja tärykalvojen punoitus ilman osoitusta välikorvan eritteisyydestä ei vielä riitä välikorvatulehduksen diagnoosin asettamiseksi. Vasemmalla tärykalvo liikkuu ja tympanogrammi on normaali -> välikorvaeritteisyys käytännössä poissuljettu. 
...
c ja d: Kyseessä on flunssaan sopiva kuva, ei tarvitse antibioottihoitoa. 
  </div>
</div>

### Mikä on otoskleroosin hoidossa käytettävä leikkausmenetelmä?
...
Otoskleroosin aiheuttaman kuuulovian tärkein hoitomuoto on leikkaus. Suomessa tehdään noin 200-300 otoskleroosileikkausta vuodessa. Leikkauksella pyritään korjaamaan jalustimen kiinnittymisen (soikeaan ikkunaan) aiheuttama äänen johtumiseste. Kiinnittynyt jalustin korvataan proteesilla.
...
![](images/stapedotomia.png)
  </div>
</div>

### Suun limakalvo on hyvin verisuonitettu, jonka takia stanssilla otetun näytepalan ottoaluekin paranee yleensä muutamassa päivässä. Näytettä otettaessa on huomioitava

- a. PAD-purkin huolellisesta käsittelystä steriliteetin säilyttämiseksi
- b. yleislääkärillä ei yleensä ole tarvittavia erikoisvälineitä saatavilla
- c. yleensä tikkiä ei tarvita, mutta tarvittaessa se on osattava laittaa
- d. suun limakalvolta näyte otetaan yleensä erikoissairaanhoidossa
...
Stanssibiopsian jälkeen ei yleensä tarvita ompeleita, mutta joskus vuoto voi olla runsasta ja on osattava laittaa tikki. 
...
b ja d: Näytteet voi ottaa PTH:ssa eikä vaadi mitään erikoisuuksia. Hammaslääkäritkin voivat ottaa näytteitä. Stanssi (4 - 8mm, erityisesti ienalue, 
suulaki, poski) tai veitsi on yleisin tapa saada näyte. 
  </div>
</div>

### Mitä seuraavista tarvitaan, jos potilaalla todetaan toispuolinen perifeerinen kasvohermohalvaus?

- a. Audiometria
- b. Varicella zoster vasta-aineet
- c. Elektrogustometria
- d. Parotiksen palpaatio
...
Toispuolinen perifeerinen kasvohermohalvaus vaatii aina tutkimista sen suhteen, että onko sen taustalla tuumori. Kyseessä voi mm. olla kasvohermoa painava kasvain korvasylkirauhasen alueella, koska kasvohermo kulkee sen läpi. Kiireellinen lähete KNK:lle on aiheellinen, jos korvasylkirauhasen palpaatiossa havaitaan resistenssi
...
c: Tutkii makuaistia; ei vaikuta diagnostiikkaan tai hoitopäätöksiin
  </div>
</div>

### Lyhyen ajan sisällä vastaanotollasi on käynyt neljä kroonista rinosinuiittia sairastavaa potilasta, joiden kaikkien esitiedot poikkeavat hieman toisistaan. Kenellä seuraavista potilaistasi krooninen rinosinuiitti on potentiaalisesti vaikeahoitoisin?

- a. Potilaalla, jolla on krooninen ei-polypoottinen rinosinuiitti + astma
- b. Potilaalla, jolla on astma + allerginen nuha + krooninen polypoottinen rinosinuiitti 
- c. Potilaalla, jolla on krooninen polypoottinen rinosinuiitti + astma + aspiriiniyliherkkyys
- d. Potilaalla, jolla on ei-polypoottinen krooninen rinosinuiitti + allerginen nuha 
...
Tämä yhdistelmä on AERD (Aspirin-Exacerbated Respiratory Disease) eli Samterin triadi. Tulehdus on todennäköisesti voimakkaasti eosinofiilinen ja polyypit kasvavat nopeasti ja uusiutuvat herkästi.  Astma on usein vaikeampi ja vaikeasti hallittava. 
  </div>
</div>

### Mikä seuraavista väittämistä on VÄÄRIN? Palan tunne eli globus on oire, johon usein liittyy 

- a. oireen provosoituminen tyhjää niellessä
- b. kivulias tunne kiinteää niellessä
- c. kaulan ja niskan lihasjäykkyys
- d. keskikaulan palpoiden todettava aristus
...
Globus pharyngeus = Palan, paineen tai epämukavuuden tunne nielussa. Ei nielemiskipua (odynofagia), nielemisvaikeutta (dysfagia) tai painonlaskua
...
d: Palpaatioarkuus voi viitata alueen lihasten jännitykseen ja keskikaulan palpaatiossa tuntuvat asiat ovat muutenkin usein ei-maligneja ja vain normaaleja rakenteita. On hyvä tiedostaa, että nielun palan tunne ilman muita oireita on vain harvoin merkki syöpätaudista. Tutkimuksen mukaan globus-potilaista n. 1% sairastuu neljän vuoden seurannassa pään ja kaulan alueen syöpätautiin eikä näissäkään tapauksissa globus-oireen yhteys syöpätautiin ollut aina selvä. 
  </div>
</div>

### TK-vastaanotollesi tulee 24-vuotias opiskelija kaulalla olevan kyhmyn vuoksi, joka huomannut partaa ajaessa noin kuukautta aiemmin. Kasvutaipumusta ei ole havainnut, mutta on huolestunut. Toteat noin 2 cm kyhmyn oikeassa kilpirauhaslohkossa muun kaulan palpaation ollessa normaali, samoin muu KNK-status on normaali. Mitä teet?

- a. Lähete kaulan ultraäänitutkimukseen ja ohutneulanäytteeseen
- b. jos T4v ja TSH ovat normaalit, ei tarvetta jatkotutkimuksille tai kontrolleille
- c. 10 vrk pitkä empiirinen antibioottihoito
- d. kontrolli 3 kk kuluttua kasvutaipumuksen selvittämiseksi
...
Epäilyttävät muutokset kilpirauhasessa (ja yleensä muutenkin pään ja kaulan alueella) tutkitaan ensisijaisesti ultraäänellä ja samalla voidaan ottaa ohutneulanäyt (ONB). 

b: Tuumorit voivat olla toimimattomia, normaalit hormonitasot eivät sulje pois neoplasiaa 

c: Ei ole viitettä infektiosta 

d: Pään ja kaulan alueen tuumorien kanssa on kiire, ei seurata 3 kuukautta 
  </div>
</div>

### Suun pohjan resistenssi
...
- a. 1 kk tulehduskipulääke
- b. Amoksisilliini-klavulaanihappo tai kefaleksiinikuuri ja tulehduskipulääke 1 kk
- c. Noin kuukauden antibiootti: amoksisilliini-klavulaanihappo tai kefaleksiinikuuri.
...
Kyseessä on vanha potilas, jolla on palpoitava resistenssi suunpohjassa, joka ei ole selvästi sylkikivi. Tämä herättää epäilyn sylkirauhasen kasvaimesta, joka aiheuttaa toistuvia sylkirauhastulehduksia. Vaatii ESH:n arviota eikä hoideta enää empiirisesti (varsinkaan nyt rauhallisessa vaiheessa) antibiooteilla tai NSAIDeilla. 
  </div>
</div>

### Mitä kalorisella kokeella voidaan tutkia?

- a. Huimauksen perifeeristä ja sentraalista erotusdiagnostiikkaa
- b. Posteriorisen kaarikäytävän hyvänlaatuista asentohuimausta
- c. Tasapainoratojen välistä puolieroa
- d. Sacculocollista refleksiä.
...
![](images/kalorisaatio.png)
  </div>
</div>


### Epäilet 19-vuotiaalla kausiluonteista nuhaa sairastavalla potilaalla koivuallergiaa. Millä seuraavista tutkimuksista voit tätä selvittää?


- a. Seerumin spesifisen IgE:n määrityksellä
- b. Veren eosinifiilimäärityksellä
- c. Seerumin kokonais-IgE-määrityksellä
- d. Epikutaanitesteillä
...
Kausiluonteinen nuha ja selkeä kausivaihtelu viittaa allergeenispesifiseen allergiaan (tässä tapauksessa koivu). Spesifinen IgE (sIgE) mitataan verestä tiettyä allergeenia vastaan, esim. juuri koivun siitepölyä. 
...
d: Epikutaanitestillä selvitetään allergiseksi epäillyn kosketusihottuman syytä, joka oireilee vähitellen ilmaantuvana kutiavana ihottumana. Puhutaan myös viivästyneen kosketusallergian tutkimuksesta. Tämä on eri asia kuin ihopistokoe eli prick-testi, jota käytetään spesifisten IgE-testien rinnalla ensisijaisena tukimuksena allergisessa nuhassa. 
  </div>
</div>


### Aikuisen uniapneapotilaan kirurgiseen hoitoon EI KUULU 

- a. Septoplastia
- b. suulaen ja kielentyven kuumennushoito (RFA) ja kieliluun nosto
- c. hypoglossus-stimulaattori
- d. partiaalinen uvulektomia 
...
Uvulopalatofaryngoplastiaa ei oikein tehdä enää, koska tulokset eivät ole mairittelevia ja CPAP-hoito on niin hyvää nykyään. Radiotaajuushoitoa on myös käytetty aikaisemmin, mutta nykyään vähemmän. 
...
d: Poistetaan osa uvulasta ja se voi auttaa obstruktiivisissa oireissa
  </div>
</div>

### Trakeostomoidun potilaan hoidon erityispiirteet.

- a. Trakeostomiakanyyli ei voi yskiessä nousta pois paikaltaan
- b. Reiällisellä ns. puhekanyylillä voidaan välttää huonosta nielemisfunktiosta johtuva mahdollinen aspiraatio
- c. Trakeostomoidun potilaan hengitysilman kostutuksesta on huolehdittava.
- d. Tukkeutunut trakeostomiakanyyli on syytä puhdistaa imulla pitämällä sisäkanyyli aina paikallaan
...
Trakeostomian kautta ilma ei kulje nenän tai edes suun kautta, joten se ei kostu ja lämmitä normaaliin tapaan. Kuiva ilma aiheuttaa limakalvojen ärsytystä, paksua limaa ja siten tukkeutumisriskiä -> kostutus on välttämätöntä. 
...
d: Jos kanyyli tukkeutuu, on sisäkanyyli otettava pois tarvittaessa. 
  </div>
</div>

### Tuttu kaveri, mutta nyt nielupaiseen avaaminen ei mene samalla tavalla
...
- a. Varmistan riittävän kipulääkityksen ja aloitan Penisilliinin (1 milj. KY x 3 x 10 vrk), todennäköisesti incisio auttaa paiseen paranemisessa vaikka selvää märkää ei tullutkaan. Ohjaan potilaan ottamaan uudelleen yhteyttä, jos oireet eivät helpota.
- b. Lähetän potilaan päivystyksellisesti sairaalaan KNK-lääkärille, paise saattaa sijaita tavallista posteriorisemmin ja/tai inferiorisemmin, joka joskus vaatii nielurisojen poiston, jotta paise saadaan avattua. 
- c. Varmistan riittävän kipulääkityksen ja aloitan Penisilliinin (1 milj. KY x 3 x 10 vrk) ja teen kiireellisen (1-7 vrk) lähetteen korvalääkärille kiireellistä tonsillektomiaa varten.
- d. Varmistan riittävän kipulääkityksen ja aloitan potilaalle Penisilliinin (1 milj. KY x 3x x 10 vrk) ja metronidatsolin (400 mg x 3 x 14 vrk) ja yritän avausta uudelleen 1-2 vrk kuluttua, kun paise on riittävästi kypsynyt.
...
Hyvävointisten aikuisten nielupaiseet voi yrittää hoitaa terveyskeskuksessa, mutta mikäli nielupaiseen avaaminen ei onnistu, potilas pitää lähettää päivystyksenä erikoissairaanhoitoon. Siellä sitten tutkitaan tarkemmin, miten paise saataisiin hoidettua. 
  </div>
</div>

### Mikä seuraavista nielurisatoimenpiteisiin liittyvä väittämä pitää paikkaansa?

- a. Nielurisojen osapoistoon liittyy enemmän jälkivuotoja ja kipuja kuin nielurisojen kokonaispoistoon
- b. Nielurisojen kokonaispoiston jälkihaittoina voi olla nielun kireyden ja palan tunnetta 
- c. Nielurisojen kokonaispoistoon liittyy suurempi risojen takaisinkasvun riski kuin nielurisojen osapoistoon
- d. Kitarisaleikkauksesta toipuminen on hyvin kivuliasta, jonka takia se yleensä tehdään lapsille jo pienenä, purentaongelmien ehkäisemiseksi
...
Fibroosin ja arpikudoksen muodostuminen leikkauksen jälkeen voi aiheuttaa kireyden tunnetta ja yleinen ärsytys ja arpikudos nielussa voi aiheuttaa palan tunnetta. 
...
d: Kitarisaleikkauksesta toipuminen voi kyllä olla kivuliasta, mutta sitä ei tehdä purentaongelmien ehkäisemiseksi, vaan jos obstruktio-oireita ilmenee lapsella. 
  </div>
</div>

### Potilaallesi sovitetaan kuulokoje onnistuneesti huonompaan korvaan ja saavutetaan symmetrinen kuulo molempiin korviin. Mikä on paras etu, jonka hän voi tästä saavuttaa?

- a. Hän kuulee selkeämmin heikkoja ääniä
- b. Hän kuulee paremmin puhelimessa
- c. Hän pystyy aistimaan äänen suunnan paremmin 
- d. Hän sietää paremmin melua
...
d: Ei ole selkeä binauraalikuulemisen etu
  </div>
</div>
...
- a. Lähete hammaslääkäriin
- b. Ei kontrollia
- c. Empiirinen antibioottikuuri 7 vrk:ta
- d. Lähete erikoissairaanhoitoon
...
Yli 40-vuotiaiden kystisiä kaulakyhmyjä tulee pitää pahanlaatuisena, kunnes toisin on osoitettu. Kaulan magneettikuvausta (tai TT) tarvitaan jatkotutkimuksena, mikäli kystisen muutoksen diagnoosi jää epävarmaksi tai potilas on yli 40-vuotias. Yli 40-vuotiailla poisto vaatii tarkkaa suunnittelua. Leikkaushoito tavanomaiseen tapaan voi heikentää potilaan ennustetta, mikäli kyseessä onkin pahanlaatuinen tauti, koska avoimesta kirurgisesta poistosta voi aiheutua syöpäsolukylvöä kaulalle ja taudin suurentunut uusiutumisriski
  </div>
</div>

### Näet kuvanmukaisen peilitutkimuslöydöksen pitkään tupakoineen naisen kurkunpäässä. Kyseessä on tuumorisuspekti muutos

- a. Vasemman äänihuulen takaosassa
- b. oikean äänihuulen etuosassa
- c. oikean äänihuulen takaosassa
- d. vasemman äänihuulen etuosassa

![](images/2022tehtävä49.png)
...
Äänihuulien ns. kolmion kärki osoittaa anteriorisesti ja koska kyseessä on laryngoscopia indirecta (LI) eli peilitutkimus, niin kuvassa oikea puoli on potilaan vasen ja vasen puoli potilaan oikea. 
  </div>
</div>

## 2023 

### 78-vuotias maanviljelijä tulee näyttämään korvalehteään, jonka iholta on viime kuukausina vuotanut verta. Toteat helixin alueella ruven, jonka alla on kraaterimainen punoittava alue. Mitkä ovat tarvittavat tutkimukset ja mikä on jatkolähetteen kiireellisyys?

- a. PVK, CRP, Thx-kuva, EKG, stanssibiopsia. Jatkolähetteen kiireellisyys PAD-vastauksen perusteella
- b. Stanssibiopsia. Jatkolähetteen kiireellisyys PAD-vastauksen perusteella
- c. PVK, CRP, Thx-kuva, EKG, stanssibiopsia. Jatkolähete 7-30 vrk kiireellisyydellä
- d. Stanssibiopsia. Jatkolähete 1-7 vrk kiireellisyydellä 
...
Tyypillinen löydös ihon okasolukasvaimelle tai basalioomalle. Ihosyöpien diagnoosi perustuu anamneesiin, kliinisen kuvaan ja histopatologiseen löydökseen. PAD-vastaus määrittää tarkasti kasvaintyypin, laajuuden ja ohjaa hoidon. Lähetettä ei tarvitse tehä ennen tulosten saapumista. 

Rutiininomaisia labroja ja kuvantamisia ei yleensä tarvita, ellei ole syytä epäillä niiden tarpeellisuutta. 
  </div>
</div>

### Kroonisesta nenän tukkoisuudesta kärsivälle 42-vuotiaalle potilaalle tehdään erikoissairaanhoidossa akustinen rinometria sekä rinomanometria tutkimukset. Mikä seuraavista väitteistä pitää paikkansa?

- a. Rinomanometrialla mitataan nenähengityksen virtausvastusta 
- b. Akustisella rinometrialla mitataan nenähengityksen painetta
- c. Rinomanometrialla saadaan tietoa mahdollisen nenäontelon kaventuman sijainnista.
- d. Rinomanometrialla mitataan nenäontelon poikkipinta-alaa
...
Äänihuulikyhmyt ilmenevät yleensö bilateraalisina kohoumina. Kyhmyt syntyvät äänihuuliin kohtaan, jossa mekaaninen rasitus on suurinta (rasitusvamma) eli yleensä etu- ja keskikolmannesten rajalle (limakalvon värähdyslaajuus on kaikkein suurin siinä). 

![](images/kurkunpäälöydökset.png)
  </div>
</div>

### Mikä seuraavista on todennäköisimmin premaligni löydös kurkunpäässä? 
...
Erytroplakia = punainen, sileä tai hiukan koholla oleva limakalvomuutos. Usein esiintyy suussa,, huulessa tai larynxissa. Liittyy korkeaan dysplasian ja transformaation riskiin.
...
d: Premaligni riski on pienempi kuin erytroplakiassa, tosin on erytroplakiaa yleisempää. 
  </div>
</div>

### Mikä seuraavista EI ole tyypillinen kroonisen nielurisatulehduksen oire?

- a. Jatkuva kurkkukipu
- b. Nielurisojen peitteet
- c. Toistuva kurkkukipu
- d. Halitoosi
...
Osalle toistuvia tonsilliitteja sairastaneista potilaista kehittyy krooninen nielurisatulehdus, jolle on tyypillistä, että nielu on aaltomaisesti jatkuvasti hieman arka (välillä vähemmän, välillä enemmän) ja lisäksi voidaan todeta joitain tyypillisiä oireita/löydöksiä, kuten pahanhajuinen hengitys (halitoosi), nielurisoista irtoava bakteerisakka (proput) ja kaulan alueen imusolmukkeiden suureneminen ja aristus. 

Nielurisat eivät sinänsä ole peitteisiä, vaan niiden kryptissa on kertymää. 
  </div>
</div>

### Mikä seuraavista väittämistä EI PIDÄ paikkansa: 

- a. Kurkunpääsyöpä on yleisempi miehillä
- b. Kurkunpääsyövän tavallisin oire on käheys
- c. Kurkunpääsyöpä on diagnosointihetkellä yleensä pitkälle edennyt
- d. Kurkunpääsyöpä esiintyy tyypillisesti pitkään tupakoineella
...
a ja d: Tupakointi ja alkoholi on tärkeimpiä kurkunpääsyövän riskitekijöitä. Näiden runsas käyttö on yleisempää miehillä. Kurkunpään syöpien ilmaantuvuus on vähentynyt viime vuosikymmeninä tupakoinnin vähentyessä. 
  </div>
</div>

### Mikä seuraavista löydöksistä puoltaa vähiten antibiootin aloitusta välikorvan tulehdukseen? 

- a. Välikorvassa on eritettä, tärykalvon asento on normaali
- b. Alle 2 vuoden ikä
- c. Vuoto tärykalvolta
- d. Molemminpuolinen tulehdus
...
Jos äkillisen välikorvatulehduksen kriteerit täyttyvät, suositellaan pääsääntöisesti antibioottihoitoa, koska osalla lapsista antibiootti nopeuttaa eritteen häviämistä ja nopeuttaa oireiden häviämistä. Erite häviää kuitenkin valtaosalla myös ilman antibioottihoitoa muutamassa viikossa. 
...
### 61-vuotias Irma kärsii uniapneaoireyhtymästä. Hänen BMI on 22. Mikä seuraavista väittämistä hänen kohdallaan EI PIDÄ paikkaansa?

- a. Irman yöuni on katkonaista, mikä voi johtua havahtumisista, hikoilusta tai lisääntyneestä virtsaamistarpeesta yön aikana
- b. Irma kuorsaa katkonaisesti. Katkoksien aikana hänen rintakehänsä tekee hengitysliikkeitä, mutta ilma kulkee huonosti
- c. Päivisin Irman on hankala keskittyä töihin ja hän unohtelee asioita
- d. Irma ei voi kärsiä uniapneasta, koska hänen BMI on normaali
...
Kyllä normaalipainoisillakin voi olla uniapnea, se vain on yleisempää ylipainoisilla. 
  </div>
</div>

### Epäilet 20-vuotiaalla naisella allergista nuhaa. Mikä seuraavista EI ole allergisen nuhan hoitomuoto?

- a. Ipratropiumbromidi nenäsuihke
- b. Montelukasti p.o.
- c. Natriumkromoglikaatti nenäsuihke
- d. Immunoterapia
...
Nuhapotilas voi hyötyä ipratropiumsuihkeesta, mikäli ei-allergisen nuhan pääoireena on runsas ja kirkas nuhaerite; eikä ole tässäkään tapauksessa ensisijainen. Iäkkäillä potilailla on myös syytä muistaa antikolinergisen lääkityksen haitat ja vasta-aiheet. 
...
d: Immunoterapialla yleensä viitataan siedätyshoitoon. Sitä voidaan harkita, jos muut hoidot eivät auta. 
  </div>
</div>

### Potilaalla on ollut toistuvasti korvatulehduksia parin viime vuoden aikana ja hänelle on määrätty useampi antibioottikuuri. Kuulokin tuntuu heikentynyneen. Tärykalvo on tämännäköinen (ks. kuva). Mitä tautia epäilet ja mitä teet?

- a. Nekrotisoiva otiitti, päivystyslähete korvalääkärille
- b. Syöpä korvassa, kiireellinen lähete korvalääkärille
- c. Kolesteatooma, lähetän korvalääkärille normaalikiireellisyydellä.
- d. Toistuvasta antibiootista aiheutunut sienitulehdus. Klotrimatsolitippakuuri 2 viikkoa ja kontrolli.

![](images/2023tehtävä30.png)
...
d: Ei näytä sienikasvulta
  </div>
</div>

### Uniapnean kirurgista hoitoa voidaan harkita, 

- a. koska lähes kaikki potilaan hyötyvät siitä
- b. jos CPAP- tai apneakiskohoito epäonnistuvat
- c. jos potilas ei halua CPAP-laitetta sen kuljettamiseen liittyvien hankaluuksien vuoksi
- d. koska CPAP-hoitoa pystyy käyttämään vain pieni osa potilaista
...
Kirurginen hoito aikuisen obstruktiiviseen uniapneaan on yleensä vasta aiheellista, jos konservatiiviset hoidot eivät toimi tai vaativat toimiakseen kirurgiaa. 

a: Teho vaihtelee huomattavasti ja varsinkin eri leikkausten välillä.

c: Ei riittävä peruste

d: Suurin osa potilaista pystyy käyttämään CPAP:ia
  </div>
</div>

### Toteat 45-vuotiaalla puoli vuotta nenän tukkoisuudesta kärsineellä miehellä nenässä molemmin puolin polyyppejä. Mikä on polyyppi?

- a. Krooniseen rinosinuiittiin liittyvä hyvänlaatuinen kasvain nenässä
- b. Krooniseen rinosinuiittiin liittyvä tulehtuneen limakalvon pullistuma
- c. Nenän limakalvomuutos, johon liittyy malignisoitumisriski.
- d. Neoplastinen muutos nenän limakalvolla
...
Polypoosi on kroonisen rinosinuiitin yksi alatyyppi. Kroonisen rinosinuiitin esiintyvyys on noin 10 %. Se jaetaan kahteen pääfenotyyppiin: ei-polypoottiseen (noin 7 %) ja polypoottiseen (noin 3 %) krooniseen rinosinuiittiin.
...
a, c ja d: Ei ole neoplastinen muutos tai tuumori -> ei malignisoitumisriskiä 
  </div>
</div>

### Korvakäytävätulehdus ei lähde parantumaan 
...
- a. Lähetän potilaan korvalääkärin hoitoon
- b. Paikallishoito ei ole riittävää. Aloitan korvakäytävän huuhtelut säännöllisesti 1-2 päivän välein ja vaihdan myös korvatipat siprofloksasiini-hydrokortisoni -tippaan (Ciproxin-Hydrocortison®), kyseessä voi olla Pseudomonas aeruginosan aiheuttama tulehdus.
- c. Epäilen tärykalvon tulehdusta ja tehostan hoitoa aloittamalla suun kautta kefaleksiini 750 mg po x 2 x 7 vrk po. antibioottikuurin.
- d. Tippa ei ole tarpeeksi laajakirjoinen, vaihdan tipan siprofloksasiini-hydrokortisoni -tippaan (Ciproxin-Hydrocortison®) ja kehotan potilasta välttämään korvakäytävän kaivelua.
...
d: Ei mainintaa säännöllisestä käytävän putsaamisesta. 
  </div>
</div>

## Toistuvia ponkiontelotulehduksia
...
- a. Potilas on juuri sairastanut akuutin rinosinuiitin, minkä jäljiltä sinuksissa on vielä tulehdusta
- b. Tulkitset röntgenkuvien muutokset limakalvokystiksi, joilla ei ole kliinistä merkitystä
- c. Potilaalla on lieväoireinen krooninen rinosinuiitti, mihin liittyen potilaalla on toistuvia akuutteja poskiontelotulehduksia mm. alentuneen mukosiliaarifunktion vuoksi
- d. Sinusten röntgenkuvaus on epäluotettava tutkimus. Tulkitset löydöksen artefaktaksi.
...
Toistuvat poskiontelotulehdukset, joista on saatu märkää punktioissa → todistaa bakteeriperäiset episodit. Limakalvoturvotus kuvissa johtuu usein pitkäaikaisesta inflammaatiosta (aiheuttaa heikentynyttä mukosiliaarista kuljetusta ja altistaa akutisoitumisjaksoille) tai polyypeista. 
...
d: Röntgenkuva ei yksin diagnosoi tilannetta, mutta kyllä osoittaa mönjät/nesteen onteloissa; ei ole todennäköisesti artefaktaa. 
  </div>
</div>

### 28-vuotias nainen tulee vastaanotolle flunssaoireiston vuoksi. Potilas kertoo sairastavansa 6-8 flunssaa vuosittain ja on tähän kyllästynyt. Mikä seuraavista on tehokkain tapa flunssan ennaltaehkäisyyn?
...
Flunssa (ylähengitysteiden virusinfektio) leviää pääasiassa kosketus- (kädet → nenä/suu/silmät) ja pisaratartuntana -> Käsihygienia on tutkitusti tehokkain yksittäinen keino flunssan ennaltaehkäisyssä, sekä väestötasolla että yksilöllisesti. 
...
c: Mahdollisesti voi lyhentää oireita ja ehkäistä tapauksia, mutta ei yhtä tehokkaasti kuin käsihygienia
  </div>
</div>

### Mitä oireita voi liittyä Bellin pareesiin? 

- a. Hajuaistin heikkeneminen
- b. Silmän kyynelvuoto
- c. Vain toinen suupieli roikkuu, muutoin miimiikka on symmetristä.
- d. Kasvojen tuntoaistin alentuminen
...
Bellin pareesi = äkillinen idiopaattinen perifeerinen kasvohermohalvaus (n. facialis). Halvauksen yksi oireista on se, että silmä ei sulkeudu kunnolla (n. facialis hermottaa m. orbicularis oculi, joka sulkee silmän). Tämä voi aiheuttaa silmän ärsyyntymistä ja vaikeutta kyynelnesteen jakautumisessa normaalisti silmän pinnalle -> valuu poskelle. 
...
d: Kasvojen tunto = n. trigeminus (V aivohermo)
  </div>
</div>

### Ruuan takaisinvirtausta
...
- a. Lähetän potilaan KNK-klinikkaan jäykällä tähystimellä tehtävää tutkimusta varten, koska se on ensisijainen tutkimusmenetelmä epäiltäessä ruokatorven yläsulkijalihaksen toimintahäiriötä
- b. Lähetän potilaan KNK-klinikkaan ruokatorven varjoainetutkimukseen, koska regurgitaatio viittaa Zenkerin divertikkeliin
- c. Lähetän potilaan gastroesofagoskopiaan, koska potilaan anamneesi huomioiden ruokatorven pahanlaatuinen tauti on mahdollinen
- d. Lähetän potilaan kaularangan röntgentutkimukseen, koska kaulanrangan osteofyytti voi estää kookkaiden palojen nielemisen
...
Vanhalla ihmisillä (Zenkerin divertikkeli ilmenee tyypillisesti vanhoilla miehillä) pitkään hitaasti paheneva nielemisvaikeus erityisesti nielemisen aikaisessa vaiheessa sekä ruoan takaisinvirtausta suuhun ruokailun jälkeen (regurgitaatio). Tämä on tyypillinen oirekuva Zenkerin divertikkelille. Potilaalla ei myöskään ole merkittäviä punaisia lippuja maligniteetin suhteen. 
...
![](images/zenkerindivertikkelipiirros.png)
![](images/zenkerindivertikkelikuvantaminen.png)
  </div>
</div>

### Alentunut kuulo pienellä pojalla
...
- a. Totean, että molemmissa korvissa on todennäköisesti liimakorva, mikä selittää kuulonaleneman. Teen lähetteen tympanostomiaan
- b. Epäily alentuneesta kuulosta on aina aihe jatkoselvityksiin, joten teen lähetteen kuulokeskukseen
- c. Epäilen, että tympanometriassa on tullut virheellinen tulos, koska tärykalvot näyttävät normaaleilta. Varaan kuulonmittaukseen ajan neuvolan kautta ja pyydän lapsen samalla käynnillä kontrolliin.
- d. Koska oireet ovat lievät, tilannetta voi vielä hyvin seurata ja sovin kontrollin kolmen kuukauden päähän

![](images/tympanometriatehtävä50.png)
...
### Dix-Hallpiken kokeella voidaan diagnosoida 

- a. aivorungon verenkiertohäiriö
- b. lateraalisen kaarikäytävän hyvänlaatuinen asentohuimaus
- c. hyvänlaatuinen posteriorisen kaarikäytävän asentohuimaus
- d. vestibulaarihermon toiminnan sammuminen
...
Hyvänlaatuisessa asentohuimauksessa (HAH, BPPV) oireita aiheuttavat otoliitit tyypillisesti (85-95%) sijaitsevat posteriorisessa kaarikäytävässä. Dix-Hallpiken testi suoritetaan siten, että: 

1. Potilas istuu tutkimuspöydällä jalat suorina
2. Käännä potilaan pää n. 45 astetta testattavalle puolelle
...
### Hyvänlaatuiseen asentohuimaukseen sopivat:

- a. Huimaus, tinnitus ja kuulonalenema
- b. Huimaus ja spontaani nystagmus 
- c. Huimaus ja tinnitus
- d. Asennonmuutoksiin liittyvä huimaus ja nystagmus 
...
- a. Tavallisempi puheammattia tekevällä. 
- b. Tupakointi on äänihuuliatrofian riskitekijä.
- c. Voidaan hoitaa väliaikaisesti botox-injektiolla.
- d. Tyypillistä äänihuulien ohentuminen.
...
Äänihuulten atrofia (presbyfonia (ikäkäheys) / atrofinen dysfonia) tarkoittaa nimenomaan sitä, että äänihuulet ohenevat -> äänihuulten sulku jää vajaaksi -> ääni on heikko, puhallusmainen, väsyvä. 
...
- a. Kyseessä on krooninen korvakäytäväntulehdus ja kolesteatooma, lähetän potilaan korvalääkärille.
- b. Potilas valehtelee ja oikeasti kaivaa korvaa topsipuikolla. Poistan haituvat korvapihdeillä ja pidän potilaalle puhuttelun manipulaation välttämisestä.
- c. Kyseessä on sienen aiheuttama korvakäytäväntulehdus, huuhdon korvan, aloitan boorihappotipat
- d. Kyseessä on krooninen korvakäytäväntulehdus, aloitan kortisonitipat 14 vrk kuurin, jonka jälkeen suosittelen potilasta kosteuttamaan korvaa Vaxol-suihkeella
...
Otoskopiassa vaaleaa, vanun / haituvan näköistä rihmastoa korvakäytävän seinämillä viittaa vahvasti sieni-infektioon. Potilas on myös todennäköisesti aikaisemmin kaivanut korvaansa paljon, mikä altistaa välikorvatulehduksille ja sieni-infektioille. 

Oikea hoito korvakäytäväinfektioissa on korvakäytävän puhdistus (todella tärkeä osa hoitoa) ja paikallishoito, aluksi esim. boorihappotipat (ei siis tarvitse heti aloittaa sienilääkkeitä tai bakteeri-infektioissa antibiootteja, jos tulehdus on lievä). Vasta tulehduksen pitkittyessä (2-7vrk kohdalla vaikeusasteeta riippuen) korvakäytäväeritteestä otetaan näytteet bakteeri- ja sieniviljelyyn. Paikallishoitoa muutetaan ja suunnataan viljelyvastausten mukaisesti
  </div>
</div>

### Mikä seuraavista väittämistä El pidä paikkaansa? 

- a. Sosiaalisesti häiritsevää kuorsausta voidaan hoitaa apneakiskolla, jota varten potilas pitää lähettää suu- ja leukasairauksien yksikköön
- b. Sosiaalisesti häiritsevä kuorsaus voi johtua nenän tukkoisuudesta, minkä takia sitä täytyy tarvittaessa hoitaa nenäkortikoidisuihkeilla 
- c. Jos sosiaalisesta häiritsevästä kuorsauksesta kärsivällä potilaalla on päiväväsymysoireita, tehdään yöpolygrafia perusterveydenhuollossa
- d. Sosiaalisesti häiritsevän kuorsauksen hoito on ensisijaisesti konservatiivista, kuten painonhallintaa ja selkäasennon välttämistä 
...
Arvio apneakiskon mahdollisesta hyödystä kuorsaavalle potilaalle ilman uniapneaa tehdään vain yksityissektorilla. Samoin CPAP ei ole korvattavissa ilman uniapneaa. 
...
d: Aikuispotilaiden kuorsauksen hoito on ensisijaisesti elintapahoitoa. Tarvittaessa painonpudotus, tupakoinnin välttäminen, uni- ja rauhoittavien lääkkeiden sekä alkoholin välttäminen ennen nukkumaanmenoa, asentohoito (selinmakuun välttäminen). 
  </div>
</div>

### Potilaalla on sosiaalisesti häiritsevä halitoosi, eli pahanhajuinen hengitys. Mitä kotikonstia voit suositella ensisijaisesti?

- a. Suuvesien käyttö
- b. Suu- ja hammashygienian tehostaminen
- c. Suolavedellä kurlaaminen
- d. Maitotuotteiden välttäminen
...
Sosiaalisesti häiritsevä halitoosi on valtaosassa tapauksista peräisin huonosta suuhygieniasta, ei nielusta eikä ruoansulatuskanavasta. 
...
d: Ei ole näyttöä, että maitotuotteet olisivat tavallinen halitoosin syy
  </div>
</div>

### Mikä seuraavista nielurisojen poistoa koskevista väittämistä pitää paikkansa? 

- a. Toimenpide tehdään lähinnä lasten obstruktiivisten risaongelmien hoitoon
- b. Aikuispotilailla toimenpiteen voi suorittaa nenän kautta tähystämällä
- c. Lapsipotilailla toimenpide on turvallisinta tehdä paikallispuudutuksessa.
- d. Aikuispotilailla nielurisakudos poistetaan yleensä kokonaan risakapselin myötäisesti
...
Tonsillektomia tarkoittaa nielurisojen kokopoistoa eli poistetaan risakudos kokonaan ekstrakapsulaarisesti. Nielurisojen osapoisto on taas tonsillotomia. Nielurisan osapoistolla tarkoitetaan nielurisakudoksen pienentämistä ilman, että kosketaan nielurisakudosta ympäröiviin kudoksiin. 
...
c: Lapsilla nielurisaleikkaus tehdään nykyään lähes aina yleisanestesiassa
  </div>
</div>

### Otsaontelossa vaakapinta
...
- a. Aloitan ksylometatsoliininenäsuihkeen sekä flutikasoninenätipat 2-3 viikoksi
- b. Teen oikealle poskiontelopunktion ja aloitan kortisoninenäsumutteen 2-3 viikon ajaksi
- c. Aloitan pelkän kortisoninenäsuihkeen 2-3 viikon ajaksi
- d. Aloitan amoksisilliini antibioottikuurin, nenästeroidisuihkeen sekä ksylometatsoliininenäsuihkeen. 
...
Tilanne sopii akuutiksi bakteeriperäiseksi otsaontelotulehdukseksi. Pitkittynyt flunssaoireilu ja oireet pahenevat paremman jakson jälkeen ("double sickening") -> viittaa vahvasti. Lisäksi kuvantamisella (ei rutiinisti tarvitse ottaa) todettu eritevaakapinta otsaontelossa -> paikannettu infektio otsaonteloon.
...
b: Ei ole ainakaan rtg-kuvan perusteella merkittävää poskiontelotulehdusta. 
  </div>
</div>

### 78-vuotias maanviljelijä tulee näyttämään korvalehteään, jonka iholta on viime kuukausina vuotanut verta. Toteat helixin alueella ruven, jonka alla on 19 mm kraaterimainen punoittava alue. Otat 3 mm stanssilla biopsian. PAD-vastaus on levyepiteelikarsinooma. Mitkä ovat tarvittavat tutkimukset ja mikä on jatkolähetteen kiireellisyys?

- a. Ei jatkotutkimuksia. Jatkohoitolähete 1-7 vrk kiireellisyydellä
- b. Tilaat PVK, CRP, Thx-kuva, EKG, kaulan uä. Samalla Jatkohoitolähete 1-7 vrk kiireellisyydellä
- c. Tilaat PVK, CRP, Thx-kuva, EKG, kaulan uä. Jatkohoitolähete päivystyksenä
- d. Tilaat PVK, CRP, Thx-kuva, EKG, kaulan uä. Vastausten saapumisen jälkeen jatkohoitolähete 1-7 vrk kiireellisyydellä
...
### Pitkään tupakoineella, perusterveellä naisella on pieni äänihuuleen rajoittuva epidermoidica. Mikä seuraavista väittämistä on OIKEIN?

- a. Kasvain voidaan hoitaa fotodynaamisella terapialla
- b. Kasvain voidaan hoitaa sädehoidolla
- c. Kasvain voidaan hoitaa boorineutronikaappaushoidolla (BNCT)
- d. Kasvain voidaan hoitaa kemosädehoidolla
...
- a. Poskiontelossa on pelkkää limakalvoturvotusta
- b. Poskiontelo on hypoplastinen
- c. Poskiontelo ei ole täynnä eritettä
- d. Poskiontelossa on kysta
...
Jos pään asennot muuttavat kaikua, niin ontelo ei voi olla täynnä nestettä, koska nesteen jakautuminen vaihtelee asennon mukaan. Istuessa saatiin takaseinäkaiku, koska ammuttiin ultraääniaalto inferioriselle pohjalla makaavan nesteen läpi. Makuulla neste jakautuu posterioriselle seinämälle, jolloin anteriorisen seinämän kohdalla ei nyt ole enää nestettä ja ultraääni heijastuu ilmapinnasta antaen etuseinäkaiun. 

![](images/uä.png)
  </div>
</div>

### Uniapnean ennuste, mikä seuraavista pitää paikkansa?

- a. Uniapnea todennäköisesti pahenee, jos lihavuutta ei hoideta.
- b. Hoitamattomalla uniapneapotilaalla on 10-kertainen riski joutua vakavaan tapaturmaan
- c. Painon pudotus ei vaikuta uniapnean vaikeusasteeseen
- d. Uniapneapotilailla on hoidosta huolimatta normaaliväestöä korkeampi kuolleisuus 
...
Totta, uniapnea tyypillisesti on etenevä sairaus hoitamattomana.
...
d: Hoidettuna ei vaikuta merkittävästi kuolleisuuteen. 
  </div>
</div>

### Potilaalla on synnynnäinen molemminpuolinen korvakäytävän puutos. Kuvantamistutkimusten mukaan välikorvat ovat ilmapitoiset, sisäkorvien ja kuulohermojen rakenteet ovat normaalit. Millaisella apuvälineellä saadaan paras kuulonkuntoutuksen tulos?

- a. Sisäkorvaistute
- b. Korvantauskuulokojeet
- c. Luuankkuroitu kuulokoje
- d. Induktiosilmukka ja kuulokoje
...
### Äänihuulihalvaus todetaan

- a. tavallisimmin oikealla
- b. tavallisimmin molemminpuolisena
- c. tavallisimmin vasemmalla
- d. yhtä usein vasemmalla kuin oikealla
...
Äänihuulihalvaus johtuu yleensä vauriosta n. laryngeus recurrens -hermossa, joka hermottaa äänihuulia. Vasemmalla hermo kiertää aortan kaaren ympäri → pidempi kulkureitti → altistuu enemmän vammoille, tuumoreille ja kirurgisille toimenpiteille. Oikean puolen hermo kulkee lyhyemmän reitin oikean a. subclavian alta → vaurioituu harvemmin. 
...
### Potilas tulee vastaanotolle tulosyyllä "nielemisvaikeus/palantunne". Mikä alla olevista viittaa neurologiseen taustaan nielemisongelman takana?

- a. Sulamatonta ruokaa palaa takaisin suuhun nielemisen jälkeen
- b. Tyhjän nieleminen pahentaa oiretta
- c. Nielemisoire vaihtelee häviten välillä kokonaan
- d. Nesteen nielemisessä on vaikeutta.
...
Vain kiinteiden ruokien ongelmat tulevat usein rakenteellisista syistä, mutta nesteiden nielemishäiriössä motiliteettihäiriö ja sen taustalla oleva neurologinen syy tulee ensiksi mieleen. 

a: Regurgitaatio on erityisen tyypillistä Zenkerin divertikkelille

b: Usein liittyy funktionaaliseen globus-oireeseen

c: Usein funktionaalinen 
  </div>
</div>

### Nenäoireilua kuukausia
...
- a. Pseudoefedriini + akrivastiini p.o.  
- b. Setiritsiini p.o.
- c. Ksylometatsoliininenäsuihke
- d. Ipratropiumbromidinenäsuihke
...
Ei-allergisen nuhan ensilinjan oireenmukaiseen hoitoon käytetään glukokortikoidisuihkeita tai antihistamiineja (vain suihkeena) tai näiden yhdistelmää. Tietysti nenän huuhtelusta nenäkannulla voi olla myös hyötyä. 
...
![](images/nenäntukkoisuus.png)
  </div>
</div>

### Potilaalla on suun limakalvolla kuvan kaltainen limakalvomuutos. Mikä on todennäköisin diagnoosi?
...
Punajäkälä (lichen ruber planus) on immuunivälitteinen iho- ja limakalvotauti, jonka syy on tuntematon. On suussa 10 kertaa yleisempi kuin ihossa ja suun punajäkälää on n. 2%:lla väestöstä. Tauti puhkeaa yleensä yli 40-vuotiaana, yleisempi naisilla. Voi kuitenkin ilmentyä myös nuorilla ja jopa lapsilla.
...
![](images/erytroplakiajaleukoplakia.png)
...
![](images/pemphigus.png)
  </div>
</div>

### Suunnistajalla vinkuu
...
- a. Liittyykö oireeseen yskää?
- b. Onko esiintynyt puristavaa tunnetta rintakehällä?
- c. Onko esiintynyt tajunnan menetystä?
- d. Missä hengityksen vaiheessa obstruktio tuntuu voimakkaimmin?
...
Alahengitysteiden obstruktio aiheuttaa uloshengityksen lopussa vinkunaa, ylähengitysteiden obstruktio taas sisäänhengityksessä. 
  </div>
</div>

### Äänihuulisyöpä:

- a. ilmaantuvuus pienenee
- b. diagnosoidaan usein pitkälle edenneenä
- c. T3-kokoluokan kasvain hoidetaan yleensä kirurgisesti
- d. on tonsilla ca:n jälkeen yleisin pään ja kaulan alueen syöpä
...
Tärkeimpiä riskitekijöitä ovat tupakointi ja alkoholi (ja näiden synergia) ja varsinkin tupakointi on vähentymässä -> kurkunpääsyövät vähentymässä. 
...
d: Suuontelon syövät ovat yleisimpiä, sitten suunielu ja vasta sitten kurkunpää. 
  </div>
</div>

### 54-vuotias kroonisesta rinosinuiitista kärsivä nainen, jolle kortisonisuihkeet aiheuttavat nenäverenvuotoja, tiedustelee suolavesihuuhteluiden hyödystä taudin hoidossa. Mitä vastaat?  

- a. Suolavesihuuhtelut ovat tutkimusten perusteella yhtä keskeinen kroonisen rinosinuiitin hoitomuoto kuin kortisonisuihkeet. 
- b. Suolavesihuuhtelut ovat tukihoito, minkä avulla voidaan lievittää oireita. 
- c. Suolavesihuuhtelut kannulla ovat tehokas tapa huuhdella erite pois poskionteloista.  
- d. Suolan laittaminen huuhtelunesteeseen ei ole tarpeellista. Pelkkä vesikin riittää.
...
Ensisijainen kroonisen rinosinuiitin hoito on nenään annosteltavat kortikosteroidisuihkeet ja nenän huuhtelu keittosuolaliuoksella. Suolavesi ei paranna kroonista tulehdusta itsessään, mutta lievittää oireita. 
...
d: Nenäkannussa käytettävä suola (suolaliuos) on välttämätön, jotta huuhteluvesi ei ärsytä tai vaurioita nenän herkkiä limakalvoja. Suola tekee vedestä fysiologisen, mikä estää limakalvojen turvotusta ja kirvelyä, poistaa tehokkaasti limaa sekä siitepölyä ja kosteuttaa nenää. Pelkkä vesi voi kuivattaa. 
  </div>
</div>

### 45-vuotias nainen tulee vastaanotollesi terveyskeskukseen. Hänellä on hieman kuumetta, kuiva yskä ja ääni lähes afoninen jo toista päivää. Mitä teet?  

- a. Kirjoitan pari päivää sairaslomaa ja määrään kefaleksiinikuurin
- b. Kirjoitan pari päivää sairaslomaa ja kehotan potilasta lepäämään ja välttämään puhumista
- c. Kirjoitan viikon sairasloman ja kehotan potilasta lepäämään ja välttämään puhumista
- d. Kirjoitan viikon sairasloman ja kehotan potilasta puhumaan kuiskaamalla
...
<div class="solution">
  ...
  <div class="solution-content">
      c (tai b työstä riippuen)

Todennäköisesti virustulehdus. Riippuen potilaan työstä voisi kyllä pari päivääkin riittää, mutta jos potilas on vähänkään puhetyötä tekevä, niin viikko on aiheellinen. Mallivastauksessa on c oikein. Toisessa tentissä siihen on lisäksi laitettu, että "kehotan potilasta käyttämään vesipiippua", joka voi myös olla hyvä lisä hoitoon. 

a: Ei kannata määrätä antibioottia empiirisesti; kefaleksiini ei muutenkaan olisi ensisijainen nielutulehduksissa 

d: Kuiskaaminen kuluttaa ääntä paljon, sitä ei kannata harrastaa kipeänä. 
  </div>
</div>

### Millainen kuulonalenema liittyy yleisimmin otoskleroosiin?

- a. Kombinoitu kuulonalenema
- b. Sensorineuraalinen kuulonalenema
- c. Johtumistyyppinen kuulonalenema
- d. Sentraalinen kuulonalenema
...
Otoskleroosi (otospongioosi) tarkoittaa väli- ja sisäkorvan luurakenteiden pesäkkeistä remodelaatiotautia, joka aiheuttaa kuulovikaa. Etiologia on tuntematon. Tauti esiintyy usein perinnöllisenä ja siksi sen geenivirheitä etsitään aktiivisesti. Myös autoimmuuni- ja infektiotaustaa on epäilty.
...
![](images/otosclerosis.png)
  </div>
</div>

### Potilaalta poistetaan leikkauksessa suurin osa nielurisakudoksesta jättäen osa kudoksesta paikoilleen. Mikä on tämän toimenpiteen nimi?

- a. Adenotonsillektomia
- b. Tonsillotomia
- c. Adenotomia
- d. Tonsillektomia
...
Tonsillotomia tarkoittaa nielurisojen osapoistoa. Nielurisan osapoistolla tarkoitetaan nielurisakudoksen pienentämistä ilman, että kosketaan nielurisakudosta ympäröiviin kudoksiin. 
...
d: Nielurisan kokopoisto
  </div>
</div>

### Vastaanotollesi tulee 45-vuotias opettaja, jonka BMI on 30. Puoliso valittaa kovaäänisestä kuorsauksesta. ESS-kyselyssä pisteet 12. Yöpolygrafiassa on lievään, obstruktiiviseen uniapneaan sopiva löydös, AHI 11. Nielussa on kookkaat tonsillat. Mitä teet?  

- a. Lähetän potilaan keuhkotaudeille CPAP-laitehoidon aloitusta varten
- b. Lähetän potilaan suu- ja leukasairauksien yksikköön apneakiskon valmistamista varten
- c. Annan potilaalle ohjeet laihduttamisesta ja lähetän korvaklinikalle arvioon nielurisaleikkausta varten
- d. Annan potilaalle ohjeet laihduttamisesta ja sovin kontrollikäynnin puolen vuoden päähän
...
d: Potilas voi hyötyä risakirurgiasta  
  </div>
</div>

### Mikä seuraavista hyvänlaatuista asentohuimausta koskevista väitteistä pitää paikkansa?  

- a. Sen ajatellaan johtuvan kuulohermon hyvänlaatuisesta kasvaimesta
- b. Sen ajatellaan johtuvan kaarikäytäviin kertyvästä otoliittisakasta
- c. Se edellyttää erikoissairaanhoidon arvion ennen hoitoa
- d. Siihen liittyy spontaani nystagmus
...
BPPV:n syynä on sakan (kalsiumkiteiden eli otokonioiden) kertyminen sisäkorvan kaarikäytävään -> häiritsevät endolymfan normaaleja liikkeitä ja ärsyttävät signaaleja välittäviä karvoja -> huimaus. Huimausta koetaan tyypillisesti pään asennonmuutoksissa otoliittien liikkuessa; erityisesti vuoteeseen käydessä tai vuoteessa käännyttäessä

a: Akustikusneurinooma eli vestibulaarischwannooma

c: Ei tarvitse, voi hoitaa PTH:ssa. Ensisijainen hoito on Epleyn manööveri. 

d: Nystagmusta ei ole levossa; esiintyy vain huimauskohtauksien aikana ja voidaan arvioida erityisesti Dix-Hallpiken kokeessa. 
  </div>
</div>

### Toteat potilaalla perifeerisen kasvohermohalvauksen ja patin parotiksessa. Miten toimit? 

- a. Ohjelmoit kiireettömän ultraäänen ja kontrollin
- b. Teet potilaasta kiireellisen lähetteen erikoissairaanhoitoon
- c. Otat avobiopsian patista ja odotat PAD-vastauksen
- d. Teet potilaasta kiireettömän lähetteen erikoissairaanhoitoon
...
Kasvohermo kulkee parotisrauhasen läpi ja tuumori parotiksessa voi joskus olla kasvohermohalvauksen taustalla. Pään ja kaulan alueen maligniteettiepäilyjen kanssa tehdään kasvohermohalvauksesta riippumatta kiireinen lähete erikoissairaanhoitoon. 

a: Kiireellinen tutkiminen aiheellista 

c: Sylkirauhasmuutoksista ei oteta avobiopsioita, vaan tarvittaessa ohutneulabiopsia 

d: Kiireellinen tutkiminen aiheellista
  </div>
</div>

### Tukkoinen nenä, ei vuotoa
...
- a. Ipratropiumbromidi nenäsuihke
- b. Setiritsiini p.o.
- c. Pseudoefedriini + akrivastiini p.o.
- d. Atselastiini + flutikasoni nenäsuihke
...
Potilaan kuvaus sopii krooniseen ei-allergiseen (vasomotoriseen) nenän tukkoisuuteen. Ensisijainen hoito on nenäkortikosteroidi (flutikasoni), jonka lisäksi voi kokeilla antihistamiinia (atselastiini) suihkeena. 

a: Tehoaa lähinnä runsaaseen kirkkaaseen nenävuotoon

b: P.o. antihistamiinit eivät sovellu ei-allergiseen ongelmaan 

c: P.o. antihistamiinit eivät sovellu ei-allergiseen ongelmaan. Pseudoefedriini kyllä lyhytaikaisesti vähentää tukkoisuutta, mutta ei ole pitkäaikainen ratkaisu.
  </div>
</div>

### Mitä lääkettä voidaan käyttää Menieren taudin hoidossa?
...
Invasiivisempia hoitomuotoja ovat välikorvaan annetut gentamisiini-injektiot, joilla on osoitettu teho huimauskohtausten hallinnassa, sekä tasapainohermon katkaisu. Kirurgisena hoitovaihtoehtona on myös sisänesterakkulan (saccus endolymphaticus) dekompressioleikkaus, mutta näyttö leikkauksen hyödystä on vähäinen
  </div>
</div>

### Äänihuulisyöpä:

- a. Ilmaantuvuus lisääntyy
- b. Tupakointi on tärkein riskitekijä noin puolessa tapauksista
- c. Tyypillinen ensioire on käheys
- d. Tyypillinen ensioire on kipu
...
Äänihuulisyöpien ennuste on yleensä juuri sen takia hyvä, että ne saadaan aikaisin kiinni, kun potilaat tulevat käheyden takia vastaanotolle. 
...
d: Kurkunpään kasvaimet harvoin aiheuttavat kipua ainakaan alkuvaiheissa
  </div>
</div>

### Millaisista hermosäkeistä kasvohermo koostuu?

- a. Kaikista edellä mainituista
- b. Vain parasympaattisista ja motorisista säikeistä
- c. Vain motorisista säikeistä
- d. Vain sensorisista ja motorisista säikeistä
...
Tärkeimmät tehtävät ovat kasvolihasten kontrollointi (motorinen), makuaisti (sensorinen), kyynelten (hermottaa kyynelrauhasia) ja syljen (hermottaa kielenalus- ja leuanalussylkirauhasia) tuotanto (parasympaattinen) + korvakäytävän tunto ja aistitun äänen säätely (m. stapediuksen motorinen hermotus). 

Loru sille, onko aivohermo sensorinen vai motorinen vai molempia (S = sensorinen, M = motorinen, B = molempia; aivohermot järjestyksessä): "Some Say Marry Money But My Brother Says Big Boobs Matter More" -> CN VII on sensorinen ja motorinen ja tämän lisäksi vielä parasympaattinen (koska hermottaa kyynel- ja sylkirauhasia). 
  </div>
</div>
...
- a. Foniatrille, epäily pitkäaikaisesta kurkunpään tulehduksesta.
- b. Neurologille, koska epäily oireiden sentraalisesta syystä
- c. Gastroenterologille, koska syöminen vaikeutunut ja epäily ruokatorven ongelmasta.
- d. KNK-lääkärille, koska epäily kurkunpään sairaudesta
...
Epäselvä >3vk kestänyt käheys -> vaatii selvittelyjä, koska kyseessä voi olla kurkunpääsyöpä. Vaikka potilaalla ei olisi tupakointitaustaa, niin silti tulisi tutkia. 

a: Mahdollinen syöpä, nyt ei mennä foniatrille

b: Ei viitteitä neurologisesta ongelmasta, on vain nielemiskipua ja käheyttä

c: Ei ole ongelmia ruokatorvivaiheessa nielemisen suhteen; on enemmänkin odynofagiaa kurkunpään alueella. Tämä yhdessä käheyden kanssa -> vahva epäily kurkunpään syövästä. 
  </div>
</div>

### 56-vuotiaalla miehellä on ollut puolen vuoden ajan lisääntyvää oikeanpuoleista nenän tukkoisuutta. Vasen puoli on täysin oireeton. Anteriorisessa rinoskopiassa toteat oikealla nenäonteloa tukkivan kudosmassan. Epäilet kasvainta. Mikä seuraavista on yleisin nenäontelon tuumori?

- a. Invertti papilloma
- b. Juveniili angiofibrooma
- c. Sinonasaalikarsinooma
- d. Hemangiooma
...
d: Hyvänlaatuinen verisuonikasvain, mutta harvinainen nenäontelossa
  </div>
</div>

### 60-vuotiaalla naisella on ollut vuosia kroonista nenän tukkoisuutta ja hajuaistin alenemaa. Nenässä on jo aiemmin todettu polyyppejä. Potilas huuhtelee nenäänsä suolavedellä päivittäin. Viime viikkoina nenän tukkoisuus on kuitenkin selvästi lisääntynyt. Mikä on hoitolinjasi?

- a. Aloitan hoidoksi akrivastiini + pseudoefedriinihoidon viikoksi
- b. Aloitan potilaalle flutikasoni nenästeroidisuihkeen
- c. Aloittamalla öljypohjaisen kostutushoidon suolavesihuuhtelujen lisäksi.
- d. Teen potilaasta lähetteen KNK-poliklinikalle leikkausarvioon.
...
Potilas kärsii kroonisesta polypoottisesta rinosinuiitista, jonka ensisijainen hoito on nenäkortikosteroidi (ja sen tukihoitona jatkuu suolavesihuuhtelu). 
